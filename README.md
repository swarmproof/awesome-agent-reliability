...
- [How We Built Our Multi-Agent Research System](https://www.anthropic.com/engineering/multi-agent-research-system) - production post-mortem of multi-agent failure modes (runaway subagents, endless search) and the prompt/eval fixes. `research`.
- [Don't Build Multi-Agents](https://cognition.com/blog/dont-build-multi-agents) - Cognition's production case (from building Devin) for single-threaded, context-sharing agents over multi-agent setups. `research`.
- [Towards a Science of AI Agent Reliability](https://arxiv.org/abs/2602.16666) - ICML 2026; 12 reliability metrics (consistency, robustness, predictability, safety); finds reliability lags accuracy on GAIA. `research`.
